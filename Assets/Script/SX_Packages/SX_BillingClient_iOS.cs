...
using SA.iOS.Examples;
    ...
    public const string ITEM1 = "wordup_1";
    public const string ITEM2 = "wordup_2";
    public const string ITEM3 = "wordup_3";
    public const string ITEM4 = "wordup_4";
    public const string ITEM5 = "wordup_5";

...
using SA.Android.Samples;
    ...
    public class SX_InApp_Android : MonoBehaviour, AN_iSkuDetailsResponseListener, AN_iConsumeResponseListener
    {
...
#if UNITY_IOS
        Destroy(GetComponent<SX_InApp_Android>());//.enabled = false;
#endif
        ...
        public const string ITEM1 = "words_us_p1";	
        public const string ITEM2 = "words_us_p2";
        public const string ITEM3 = "words_us_p3";	
        public const string ITEM4 = "words_us_p4";	
        public const string ITEM5 = "words_us_p5";
